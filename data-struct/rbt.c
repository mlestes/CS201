...
/*                                                                           */
/*     int findRBTNode(RBT *r, void *value):                                 */
/*          Returns the given value if it is in the given tree.              */
/*                                                                           */
...
void *getNode(rbtnode *node){return node->store;}
